...
| 版本 | 说明 | 主题 |
|---|---|---|
| [v4.1](./v4.1-release-notes.md) | 2026-09 | **网关传输自愈 · 长轮询窗口封顶 · 长回合进度提前**：传输层故障后自动改走新建连接（不必重启进程）、服务端建议的长轮询窗口不得顶掉配置值、长回合首条进度约 20 秒发出；另修掉 Linux CI 必红的那条用例，并补齐灯控地址的破坏性变更说明 |
